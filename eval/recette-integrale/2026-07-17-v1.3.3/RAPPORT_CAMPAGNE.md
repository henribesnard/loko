# RAPPORT DE CAMPAGNE — 2026-07-18 06:26 UTC

**Version** : 1.3.2
**Tag** : v1.3.3
**Commit** : 0214d59
**Image digest** : sha256:2fcacf6c3c299
...
| CE-2 | Tag present + triple version check | FAIL FAIL | tag=v1.3.3, pyproject=1.3.2 | - |
| CE-3 | Docker image built + size <= 1.6 Go | PASS PASS | image=loko:v1.3.3, size=1001MB | CE-3.txt |
...
| CE-7 | Campaign artifacts directory exists | PASS PASS | eval\recette-integrale\2026-07-17-v1.3.3 | 2026-07-17-v1.3.3 |
...
| V1-4 | CRITICAL log at boot (check_published_bots) | PASS PASS | CRITICAL loggé au boot pour bot publié sans modèle (v14-ce6d3a1b) | V1-4_boot_critical.txt |
...
| V2-1 | Training time <= 300s | FAIL FAIL | train 463s > 300s | - |
...
| V2-4 | Improvement cycle: pair detected + re-train | PASS PASS | paire hors_perimetre×help_leave détectée (lowest_f1 (matrice propre)), +10 ex., retrain OK | V2-4_pair.json |
| V2-5 | Improvement cycle: verify pair resolved | FAIL FAIL | cellules indisponibles — accuracy avant=0.914 après=0.894 | - |
| V2-6 | Classification P95 <= 50ms (machine de reference) | FAIL FAIL | P95=106.42ms (contre-mesure 106.42ms, écart 0%), n=200, in-container | - |
| V3-0 | Sweep Pareto 3-axis + selection | PASS PASS | haut=0.85 bas=0.50 ecart=0.00 | GNG-1=81.0% GNG-2=88.8% GNG-3=80.0% | selection.json |
| V3-1 | GNG-1 >= 85% (heldout_metier) | FAIL FAIL | GNG-1=81.0% (81/100) | - |
| V3-2 | GNG-2 >= 90% (heldout_conseiller) | FAIL FAIL | GNG-2=88.8% (111/125) | - |
| V3-3 | GNG-3 >= 80%, routes directes <= 5 (heldout_horsscope) | PASS PASS | GNG-3=80.0% (80/100) | report.json |
| V3-4 | Pieges >= 12/15 commentes | FAIL FAIL | pieges=60.0% (9/15) | - |
| V3-5 | Modele + seuils + manifeste geles | PASS PASS | manifest_hash=c5ffe2ee3a9f56f7... | manifest.json |
...
|---|---|---|---|
| CE | Conditions d'entree (bloquant) | FAIL FAIL | 8/9 passed |
...
| G-2 | Training R1.a | FAIL FAIL | 3/6 passed |
...
**NON VALIDE** — Gates en échec : CE, G-0, G-2, G-3
